...
use FireHub\Core\Throwable\Error\LowLevel\FileSystem\ {
    CannotListError, ChangeSymlinkGroupError, ChangeSymlinkownerError, CreateFolderError, CreateSymlinkError,
    DeletePathError, DiskSpaceError, GetAbsolutePathError, GetGroupError, GetInodeError, GetLastAccessedError,
    GetLastChangedError, GetLastModifiedError, GetOwnerError, GetPermissionsError, GetStatisticsError, GetSymlinkError,
    ParentLevelTooSmallError, RenameError, SearchError, SetGroupError, SetLastAccessAndModifyError, SetOwnerError,
    SetPermissionsError
};
