...
/**
 * ### Provides low-level access to declared runtime symbols
 *
 * This class exposes thin wrappers around PHP internal reflection functions used to retrieve declared classes,
 * interfaces, traits, constants, and functions at runtime.
 * @since 1.0.0
 *
 * @internal
 *
 ...
 */
final class Declared extends LowLevel {
     ...
     *
     * Returns the names and values of all the constants currently defined.<br>
     ...
     * A multidimensional array containing a list of all defined functions, both built-in (internal) and user-defined.<br>
