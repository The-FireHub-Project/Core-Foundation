...
/**
 * ### Invalid autoload namespace exception
 * @since 1.0.0
 */
class InvalidNamespaceException extends Exception {
     ...
     * @since 1.0.0
     */
    protected const string DEFAULT_MESSAGE = 'Autoload namespace is invalid.';

    /**
     * ### Empty autoload namespace
     * @since 1.0.0
     *
    ...
    public static function empty ():self {
        ...
        return new self('Autoload namespace cannot be empty');
