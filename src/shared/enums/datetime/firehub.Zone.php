 ...
 * ### Timezone Enum
 *
 * Represents all supported timezones in the FireHub framework.<br>
 * This enum ensures type-safety for date/time operations and provides utility methods for validation and conversion.
 *
 * @since 1.0.0
 *
 * @api
