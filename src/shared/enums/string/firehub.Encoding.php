...
/**
 * ### Represents a set of predefined string encodings
 *
 * This enum provides a fixed set of supported character encodings for multibyte string operations across FireHub Core.
